...
class TestGetBuildDir(unittest.TestCase):
    ...
    def test_with_builddir(self):
        ...
        build_dir = get_build_dir(build_dir=build_path,
                                  repo_root=None,
                                  version=None)
    ...
    def test_builddir_and_reporoot(self):
        ...
        with self.assertRaises(RuntimeError):
            _ = get_build_dir(build_dir=self.path_to_foo,
                              repo_root=self.path_to_repo,
                              version=None)
    ...
    def test_reporoot_and_version(self):
        ...
        with mock.patch('os.path.isdir') as mock_isdir:
            ...
            build_dir = get_build_dir(build_dir=None,
                                      ...
                                      version=ver)
        expected = (
            os.path.join(path_to_repo_versions, ver),
            ver
        )
        self.assertEqual(expected, build_dir)
    ...
    def test_reporoot_and_version_dir_not_exist(self):
        ...
        get_build_dir(
            build_dir=None,
            repo_root=self.path_to_parent_repo,
            version="v1.0"
        )
